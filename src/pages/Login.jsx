...
import { zebrPresenting } from '../assets/mascot';
    ...
    <div className="min-h-screen pt-32 pb-20 px-4 flex items-center justify-center">
      ...
      >
        <div className="text-center space-y-2">
          <img 
            src={zebrPresenting} 
            alt="ZEBR Mascot Login" 
            className="w-24 h-28 object-contain mx-auto filter drop-shadow-md hover:scale-105 transition-transform" 
          />
          <h1 className="text-2xl font-black text-slate-900 dark:text-white">Hesabınıza daxil olun</h1>
          <p className="text-slate-500 dark:text-slate-400 text-xs">
            ZEBR Market hesabınızla sifarişlərinizə və lisenziyalarınıza baxın
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <a href="#forgot" className="text-slate-500 hover:text-slate-900 dark:hover:text-white underline">
                Şifrəni unutmusunuz?
              </a>
            </div>
            <div className="relative">
